...
const CurrentWeather = (props) => {
    ...
    return (
        <div className='CurrentWeather'>
            ...
            <p>
                <img src={`https://developer.accuweather.com/sites/default/files/${currentWeather[0].WeatherIcon < 10 ? '0' + currentWeather[0].WeatherIcon : currentWeather[0].WeatherIcon}-s.png`} alt='img'/>
            </p>
            <WeekWeather/>
        </div>
    )
